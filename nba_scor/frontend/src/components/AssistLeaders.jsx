...
export default function AssistLeaders({ leaders }) {
  if (!leaders) return null

  return (
    <div className="assist-leaders-container">
      ...
      <div className="leaders-table">
        <div className="table-header">
          ...
          <div className="stat-col">APG</div>
        </div>
        {leaders.map((leader) => (
          <Link
          ...
          >
            ...
            <div className="stat-col assists-highlight">{leader.assists.toFixed(1)}</div>
          </Link>
        ))}
      </div>
    </div>

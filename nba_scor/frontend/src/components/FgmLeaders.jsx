...
export default function FgmLeaders({ leaders }) {
  if (!leaders) return null

  return (
    <div className="field-goals-leaders-container">
      <h3>Field Goals Leaders</h3>
      <div className="leaders-table">
        <div className="table-header">
          ...
          <div className="stat-col">FGM</div>
        </div>
        {leaders.map((leader) => (
          <Link
          ...
          >
            ...
            <div className="stat-col field-goals-highlight">{leader.field_goals.toFixed(1)}</div>
          </Link>
        ))}
      </div>
    </div>

...
export default function PointsLeaders({ leaders }) {
  if (!leaders) return null

  return (
    <div className="points-leaders-container">
      ...
      <div className="leaders-table">
        <div className="table-header">
          ...
          <div className="stat-col">PPG</div>
        </div>
        {leaders.map((leader) => (
          <Link
          ...
          >
            ...
            <div className="stat-col points-highlight">{leader.points.toFixed(1)}</div>
          </Link>
        ))}
      </div>
    </div>

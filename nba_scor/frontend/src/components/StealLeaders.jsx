...
export default function StealLeaders({ leaders }) {
  if (!leaders) return null

  return (
    <div className="steals-leaders-container">
      ...
      <div className="leaders-table">
        <div className="table-header">
          ...
          <div className="stat-col">SPG</div>
        </div>
        {leaders.map((leader) => (
          <Link
          ...
          >
            ...
            <div className="stat-col steals-highlight">{leader.steals.toFixed(1)}</div>
          </Link>
        ))}
      </div>
    </div>
